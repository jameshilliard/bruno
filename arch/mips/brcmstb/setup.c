...
#define BRUNO_EMERGENCY_NAME   "emergency"
...
#define BRUNO_KERNEL0_SIZE     0x02000000UL
#define BRUNO_KERNEL1_SIZE     0x02000000UL
#define BRUNO_ROOTFS0_SIZE     0x12000000UL
#define BRUNO_ROOTFS1_SIZE     0x12000000UL
#define BRUNO_EMERGENCY_SIZE   0x02000000UL
#define BRUNO_DATA_SIZE        0x15F00000UL
/* Leaving last 1MB for BRCM BBT */
...
#define BRUNO_EMERGENCY_OFFSET (BRUNO_ROOTFS1_OFFSET+BRUNO_ROOTFS1_SIZE)
#define BRUNO_DATA_OFFSET      (BRUNO_EMERGENCY_OFFSET+BRUNO_EMERGENCY_SIZE)
...
static struct mtd_partition fixed_nand_partition_map[] =
{
  ...
  {   name: BRUNO_EMERGENCY_NAME, size: BRUNO_EMERGENCY_SIZE, offset: BRUNO_EMERGENCY_OFFSET },
